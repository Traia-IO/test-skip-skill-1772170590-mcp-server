...
# Script to build and run the Test Skip Skill 1772170590 MCP Server locally in Docker
...
IMAGE_NAME="test-skip-skill-1772170590-mcp-server"
CONTAINER_NAME="test-skip-skill-1772170590-mcp-local"
HOST_PORT=${PORT:-8000}
CONTAINER_PORT=${PORT:-8000}

echo -e "${BLUE}🚀 Building and running Test Skip Skill 1772170590 MCP Server...${NC}"
echo
...
if [ ! -f .env ]; then
    ...
    if [ -f .env.example ]; then
        ...
        cat > .env << EOF
# Test Skip Skill 1772170590 MCP Server Configuration
PORT=8000
STAGE=MAINNET
LOG_LEVEL=INFO
...
echo
echo -e "${GREEN}✅ Test Skip Skill 1772170590 MCP Server is running!${NC}"
echo
